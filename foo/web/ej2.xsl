        ...
        <div class="container jumbotron">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              Genera la tabla ordenada alfabeticamente. Quienes tienen mas de 10000 miaus, se les
              añade "cat" al nombre. Quienes tengan menos de 10000, se les añade "dog"
              Se añade una columna total que es la suma de POSTS + COMENTARIOS
            -->
            ...
            <tbody>
              <xsl:for-each select="USERS/CAT">
                ...
                <xsl:choose>
                  ...
                  <xsl:when test="MIAUS &gt; 10000">
                    <tr>
                      <td><xsl:value-of select="concat(NICK, ' cat')"/></td>
                      <td><xsl:value-of select="POSTS"/></td>
                      <td><xsl:value-of select="COMMENTS"/></td>
                      <xsl:variable name="a" select="POSTS"/>
                      <xsl:variable name="b" select="COMMENTS"/>
                  ...
                  <xsl:otherwise>
                    <tr>
                      <td><xsl:value-of select="concat(NICK, ' dog')"/></td>
                      <td><xsl:value-of select="POSTS"/></td>
                      <td><xsl:value-of select="COMMENTS"/></td>
                      <xsl:variable name="a" select="POSTS"/>
                      <xsl:variable name="b" select="COMMENTS"/>
